...
required_files=(
    ...
    "htmx-apps/ai_chat.html:AI Chat HTMX app"
    "htmx-apps/document_analysis.html:Document Analysis HTMX app"
    "htmx-apps/web_search.html:Web Search HTMX app"
    "htmx-apps/server.py:HTMX server"
    "config/apps.json:Apps configuration"
    "scripts/deploy.sh:Deployment script"
    "htmx-apps/Dockerfile:HTMX Docker configuration"
